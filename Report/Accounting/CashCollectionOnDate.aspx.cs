...
{
    public partial class CashCollectionOnDate : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DataTable dt)
        {
            ...
            var ds = new ReportDataSource("CashCollectionDS", dt);
            DataHelper.generateAccountingReport(ReportViewer1, "CashCollectionOnDate", reportParameters, ds);
        }
    }
}