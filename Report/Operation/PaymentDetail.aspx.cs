    ...
    public partial class PaymentDetailV2 : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            var sql = "SELECT PM.id,PM.payment_type,PM.payment_date,C.customer_name,ST.ticket_no,P.lob_name, " +
                ...
                " LEFT JOIN(SELECT system_date_id, contract_id, schedule_ticket_id, SUM(waive_amount) waive_amount FROM waive WHERE waive_status = 2 GROUP BY system_date_id, contract_id, " +
